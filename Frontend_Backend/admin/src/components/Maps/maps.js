...
const App = () => {
  ...
  useEffect(()=>{
    Fetch();
  },[success,successdeal,finalsucess]);
  // const addBinClick = () => {
  //   console.log("Aditya");
  //   setgetlat22(" ");
  //   setgetlon22(" ");
...
map.addControl(new mapboxgl.NavigationControl());
    ...
    // Clean up on unmount
    return () => map.remove();
  }, [success,finalsucess,successdeal]);
    ...
    <div className="map-container" ref={mapContainerRef}>
      ...
      {/* <div className="sidebar2">
        <div class="multi-button">
          ...
          <button class="btn-secondary" onClick={remBinClick}>Delete Bins</button>
          <button class="btn-secondary-custom" onClick={addDealClick}>Add Dealers</button>
          <button class="btn-secondary-custom2" onClick={remDealClick}>Rem Dealers</button>
        </div>
      </div> */}
